...
大阪駅から名古屋までの主な交通手段の一例を表に示します。
高速バスは編集(2026-07-25)時点での平日と土日の最安値を表示しています。

| 交通手段 | 費用              | 所要時間      | 費用×時間   | ルート                   |
| :------- | :---------------- | :------------ | :---------- | :----------------------- |
| 新幹線   | 5,940円           | **1時間10分** | 415,800     | 大阪→新大阪→名古屋       |
| JR在来線 | 3,410円           | 2時間45分     | 562,650     | 大阪→名古屋              |
| 高速バス | **1,500-1,800円** | 3時間05分     | **277,500** | WhillerBT大阪梅田→名古屋 |
| 近鉄特急 | 5,190円           | 2時間30分     | 778,500     | 大阪→難波→近鉄名古屋     |

表からわかるように、**所要時間では新幹線**が、**単純な費用および費用×所要時間のコストパフォーマンス指標では高速バス**が有利となっています。人により費用と所要時間のどちらを重視するのかは変わってくるため費用<sup>2</sup>×所要時間のように指数を変化して計算してみると良いと思います。

近鉄特急は一見どの指標からみても不利に見えますが、大阪ミナミ周辺から乗り換えを少なくして名古屋に行きたい場合や、**近鉄ひのとり**といったグリーン車以上に快適な車両に指定席程度の料金乗れるという理由から、一定の需要があります。

一方でJR在来線はこう見るとあまり選択肢には上げにくいでしょう。特に高速バスと比較するとかなり不利になってしまいます。名阪間で乗り通すのは**青春18きっぷ**やその他在来線の乗り放題切符を使用する場合、ゆっくり在来線での移動を楽しむという場合でしょうか。
