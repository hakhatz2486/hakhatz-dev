...
- [GitHub](https://github.com/hakhatz2486)
    ...
    - [gruvbox-zed-for-chrome](https://github.com/hakhatz2486/gruvbox-zed-for-chrome): Zedエディタ向けに調整されたGruvboxのカラーパレットを、Google Chrome用に移植したテーマです。ダークモード用とライトモード用両方あります。
